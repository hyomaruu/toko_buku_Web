...
export default function UsersEditPage(
  ...
  const handleFetchData = (userData: string) => {
      setFetchLoading(true)
      getAdmin(userData).then((response: Response<Admin>) => {
        if(response?.data) {
          setDataForm({
            ...dataForm,
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const response: Response<Admin> = await updateAdmin(params?.user, payload)
            ...
            <div className="grid gap-16 mb-10 md:grid-cols-2">
              <div className="text-lg">
                ...
                <div className="p-4 italic bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg block w-full dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                  Hanya user dengan role <span className="font-bold">Pemilik</span> saja yang dapat mengubah user baru.
                </div>
              </div>
              <div className="space-y-6">
                  <div>
                    ...
                    <div className="relative mb-6">
                      ...
                      <input value={dataForm?.username} onChange={(e) => setDataForm({...dataForm, username: e?.target?.value})} type="text" id="username" name="username" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="test@gmail.com" required/>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex">
                      ...
                      <input value={dataForm?.nama_lengkap} onChange={(e) => setDataForm({...dataForm, nama_lengkap: e?.target?.value})} type="text" id="name" name="nama_lengkap"  className="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan nama lengkap" required/>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex">
                      ...
                      <input value={dataForm?.password} onChange={(e) => setDataForm({...dataForm, password: e?.target?.value})} type="password" id="password" name="password" className="rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan password baru" required/>
                    </div>
                  </div>
                  <div>
                    <label htmlFor="role" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Role</label>
                    <select value={dataForm?.role} onChange={(e) => setDataForm({...dataForm, role: e?.target?.value})} id="role" name="role" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
