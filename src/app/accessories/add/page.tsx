...
import { Accessoris, addAccessoris } from "@toko-buku/controllers/accessoris";
...
export default function Page() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const response: Response<Accessoris> = await addAccessoris(payload)
    ...
    <>
      <div className="my-10 pb-10 h-screen overflow-y-auto">
        <div className="flex items-center justify-between mb-8">
              <h1 className="font-semibold text-xl ">Tambah Aksesoris</h1>
        </div>

        <form onSubmit={onSubmit}>
            <div className="grid gap-16 mb-10 md:grid-cols-2">
              <div className="text-lg">
                Berikut merupakan form tambah aksesoris.
                <br />
                Isilah data-data yang diperlukan agar dapat menambahkan aksesoris kedalam aplikasi.
                <br />
                <br />
                <div className="p-4 italic bg-gray-50 border border-gray-300 text-gray-900 text-base rounded-lg block w-full dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                  Hanya user dengan role <span className="font-bold">Staf dan Pemilik</span> saja yang dapat menambahkan aksesoris baru.
                </div>
              </div>
              <div className="space-y-6">
                  <div>
                    <label htmlFor="kode" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kode</label>
                    <div className="relative mb-6">
                      ...
                      <input type="text" id="kode" name="kode" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukan kode aksesoris" required/>
                    </div>
                  </div>

                  <div>
                    <label htmlFor="nama_barang" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Barang</label>
                    <div className="relative mb-6">
                      <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                      <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
